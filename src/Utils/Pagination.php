...
class Pagination
{
    ...
    /** The number of the current page (bounded between 1 and $countPages) */
     ...
     * @return Pagination<T>
     */
    public static function paginate(ORM\Query $query, int $page, int $limit = 25): self
    {
        ...
        $maxPage = intval(ceil($countAll / $limit));
        if ($page > $maxPage) {
            $page = $maxPage;
        }
        ...
        return new self($items, $countAll, $limit, $page);
    }
